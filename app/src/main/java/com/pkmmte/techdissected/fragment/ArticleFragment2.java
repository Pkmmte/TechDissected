...
public class ArticleFragment2 extends Fragment {
	...
	private void setupShare() {
		...
		shareIntent.putExtra(Intent.EXTRA_TEXT, article.getSource().toString());
	...
	public static ArticleFragment2 newInstance(Article article)
	{
		ArticleFragment2 mFragment = new ArticleFragment2();
